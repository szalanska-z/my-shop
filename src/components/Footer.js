			...
			<div className="container">
				<div className="row">
					...
					<div className="col-md-5 my-3 text-center">
						...
						<a href="http://instagram.com"><i className="icon-instagram icon-social"></i></a>
						<a href="http://facebook.com"
						><i className="icon-facebook icon-social"></i></a>
						<a href="http://twitter.com"><i className="icon-twitter icon-social"></i></a>
					</div>
				</div>
			</div>
		</div>
